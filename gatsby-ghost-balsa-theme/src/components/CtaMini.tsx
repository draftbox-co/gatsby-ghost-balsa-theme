      ...
      {!succeeded && (
        <section className="px-4 py-8 bg-gray-200" id="subscribe">
          <div className="w-full max-w-2xl mx-auto text-center">
            <h2 className="text-3xl mt-4 mb-8 leading-tight font-sansSemibold">
              <span
                dangerouslySetInnerHTML={{
                  __html: `${
            ...
            >
              <div className="flex flex-wrap mb-4">
                ...
                <div className="w-full md:w-1/3">
                  <button className="inline-block w-full py-4 px-8 leading-none text-white bg-primary hover:bg-primaryActive rounded md:rounded-l-none tracking-wide font-sansBold focus:outline-none">
